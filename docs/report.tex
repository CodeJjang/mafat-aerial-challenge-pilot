...
I now wanted to check whether using a pretrained ResNet-50 would encourage transfer-learning and help to improve the classification accuracy.
Again, I trained the pretrained ResNet-50 for 90 epochs.
...
Just like in the previous experiments the pretrained network beat the other fully trained network, but with a small gap. The network here reached 52.710\% precision on this feature.
