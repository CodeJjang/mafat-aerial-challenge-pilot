...
I now wanted to test the combination the scale parameter values, thus I set the scale size to be [600, 1600] (meaning each image would be scaled twice, by the two factors).\\
Results:\\
Large Vehicle AP = 0.4987\\
Small Vehicle AP = 0.8917\\
Solar Panel AP = 0.6431\\
